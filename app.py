...
# --- [المفاتيح السيادية]: جلب الترسانة من Secrets بنجاح ---
SERPER_KEY = st.secrets.get("SERPER_KEY", "4ixTmKayOF0VFhx212wTftQc6oTjYEmt")
OPENROUTER_KEY = st.secrets.get("OPENROUTER_KEY", "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")
SHODAN_KEY = st.secrets.get("SHODAN_KEY", "1a92c26cc25d4a783734c837e85358f58f9ad8f6")
GROQ_KEY = st.secrets.get("GROQ_KEY", "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")
APIFY_KEY = st.secrets.get("APIFY_KEY", "apify_api_N7YpyJ4RbApG9JB8AuvORbdEU7gZRU0KVYyW")
